...
const cardVariants = cva("absolute will-change-transform transform-gpu", {
  variants: {
    variant: {
      dark: "flex size-full flex-col items-center justify-center gap-6 rounded-2xl border border-stone-700 bg-accent-foreground p-6",
      light:
        "flex size-full flex-col items-center justify-center gap-6 rounded-2xl border bg-accent bg-background p-6",
    },
  },
  defaultVariants: {
    variant: "light",
